...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC,                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_GRV,  \
    ...
    LOWER,   RAISE,   KC_RALT, KC_LALT,          KC_SPC,  KC_BSPC,KC_DEL,         KC_BSPC,KC_ENT , KC_SPC,           KC_LBRC, KC_RBRC, KC_MINS,   KC_EQL \
  ),
