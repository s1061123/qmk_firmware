...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Lower|  GUI |  ALT | ALT  |||||||| Space| Bksp |  Del |||||||| Bksp | Enter| Space||||||||   {  |   }  |   -  |  =   |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    LOWER,   RAISE,   KC_LGUI, KC_LALT,          KC_SPC,  KC_BSPC,KC_DEL,         KC_BSPC,KC_ENT , KC_SPC,           KC_LBRC, KC_RCBC, KC_MINS,   KC_EQL \
  ),
